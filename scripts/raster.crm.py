...
# Add parent directory to Python path to import crms modules
...
if __name__ == '__main__':
    ...
    parser.add_argument('--type', type=str, required=True, help='Type of the raster')
    ...
    crm = Raster(args.name, args.type, args.original_tif_path)
